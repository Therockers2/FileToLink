...
class Var(object):
    MULTI_CLIENT = False
    API_ID = int(getenv('API_ID', '7272529'))
    API_HASH = str(getenv('API_HASH', '68532ee254128bd6f169a1b32bde7db5'))
    BOT_TOKEN = str(getenv('BOT_TOKEN', '7265421555:AAG-K7Z1sTVx10O5AGOhLuYXDxUyLvJ7FTQ'))
    name = str(getenv('name', 'filetolinkvjbot'))
    SLEEP_THRESHOLD = int(getenv('SLEEP_THRESHOLD', '60'))
    WORKERS = int(getenv('WORKERS', '4'))
    BIN_CHANNEL = int(getenv('BIN_CHANNEL', '-1002188014900'))
